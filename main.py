...
#pickle_out = open("model_trained3.pickle", "wb")  # wb = WRITE BYTE
#pickle.dump(model, pickle_out)
#out =pickle.dump(model, open("model_trained.pickle", 'wb'), protocol=2)
#pickle_out.close()
model.save('my_modeql.h5')  # creates a HDF5 file 'my_model.h5'
